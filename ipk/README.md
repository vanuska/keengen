...
Пакет **0.1.2-1** для `mipsel-3.4`: статика + `keengen-httpd` (ветка **`main`**).
...
Артефакт: `dist/keengen_0.1.2-1_mipsel-3.4.ipk` (в git не кладётся). Сборка снимает CRLF со всех текстовых файлов в stage.
