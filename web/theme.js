...
var KG_I18N={
 ru:{
  ...
  ipkHint:'На ПК нужен SSH root в «Настройка входа». На роутере (:1001) кнопка ставит сама. Всегда качается latest с GitHub. XKeen-UI на :1000 не трогается.',
  ...
  ipkAppUpdate:' · есть новая версия helper — обновите папку standalone / git',
 ...
 en:{
  ...
  ipkHint:'On PC you need SSH root in Login settings. On the router (:1001) the button installs locally. Always downloads GitHub latest. XKeen-UI on :1000 is untouched.',
  ...
  ipkAppUpdate:' · newer helper available — refresh standalone / git',
