...
4. Строка версий: keengen на ПК · GitHub · версия на роутере (если уже стоит). Статус входа — только зелёная/красная рамка у «Настройка входа» (без текста «вход проверен»).
