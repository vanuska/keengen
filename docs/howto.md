...
Репозиторий на GitHub — полное зеркало Gitea. Не коммитить: журналы агента (`AGENT/`), `AGENTS.md`, пароли, токены, ключи, живые `vless://`. Правки — на Gitea, не на GitHub. Подробнее: [SECURITY.md](../SECURITY.md).
